...
export const USDPriceMap: { [key in string]: TokenPrice } = {
  ...
  PUhuAtMHsKavMTwZsLaDeKy2jb7ciETHJP7rhbKLJGY: {
    mint: 'PUhuAtMHsKavMTwZsLaDeKy2jb7ciETHJP7rhbKLJGY',
    usd: 1.11,
    cap: 0,
    decimals: 9,
    coingeckoId: 'usn',
