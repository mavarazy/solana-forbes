      ...
      <div className="relative px-4 mb-8 sm:px-6 lg:px-8">
        <div className="text-lg max-w-prose mx-auto">
          <p className="mt-8 text-xl text-gray-500 leading-8">
            ...
            related DeFi ecosystem. A crypto Forbes, with net worth and
            anonymity.
          </p>
        </div>
        <div className="mt-6 prose prose-indigo prose-lg text-gray-500 mx-auto">
          ...
          <p>
            ...
            . This is not ideal and most likely missed few accounts here and
            ther, but for MVP it was good enough.
          </p>
          ...
          <p>
            Both would be only partially reliable, because again for both
            official Solana
            <a
              href="https://github.com/solana-labs/token-list"
              className="mx-2"
